/**
 * JSX-to-template-literal code generation.
 *
 * Converts JSX elements and fragments into Babel TemplateLiteral AST nodes
 * that produce HTML strings at runtime.  This is the heart of the Gea compiler's
...
} from '../analyze/binding-resolver.ts'
